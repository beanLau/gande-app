<template>
	<view class="container">
		<uni-nav-bar v-if="jibie == 3 && authorizeMenu.dangjian.xinjiandangkehuiyi" status-bar @clickLeft="pageBack" right-text="创建会议" @clickRight="toCreateTask" left-icon="back" left-text="返回" color="#fff" fixed background-color="#DE1727" title="党课会议"></uni-nav-bar>
