	...
	export default {
		data() {
			return {
				...
				villageList: [{
					...
					reportName: "张倩",
					audios: [{
						src: 'https://win-web-nf01-sycdn.kuwo.cn/c1db2898e9485739072e581ea687b462/5f049519/resource/n1/67/51/2169215908.mp3',
						isPlay: false,
						len: '00:50'
					},{
						src: 'https://win-web-nf01-sycdn.kuwo.cn/c1db2898e9485739072e581ea687b462/5f049519/resource/n1/67/51/2169215908.mp3',
					...
					reportName: "张倩",
					audios: [{
						src: 'https://ev-sycdn.kuwo.cn/461fd5813d1fe547def86ac116c5fb45/5f048e14/resource/n2/55/77/2975270418.mp3',
						isPlay: false,
						len: '00:50'
					}]
				},{
		...
		methods: {
			...
			playAudio(e){
				...
				let src;
				console.log(idx == currentVillage && index == currentAudioIndex)
				if(idx == currentVillage && index == currentAudioIndex){ //点击当前播放的音频
					//停止播放
					...
					// 	this.innerAudioContext.stop();
					// }
					src = list[idx].audios[index].src || 'https://win-web-nf01-sycdn.kuwo.cn/c1db2898e9485739072e581ea687b462/5f049519/resource/n1/67/51/2169215908.mp3'
					//播放对应音频
					uni.showLoading({
						title: '音频资源加载中'
					});
